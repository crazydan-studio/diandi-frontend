...
module App.Store.Msg exposing (Msg(..), opResultDecoder, statsResultDecoder)
...
type Msg
    ...
    | CountMyTopics Bool (Result Http.Error StatsResult)
...
statsResultDecoder : Decoder StatsResult
statsResultDecoder =
    Decode.succeed StatsResult
        |> required "size" int
